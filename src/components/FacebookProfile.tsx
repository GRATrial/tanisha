...
export const FacebookProfileView: React.FC<FacebookProfileProps> = ({ resultId, onClose, persona = 'tanisha', condition, prolificParams }) => {
      ...
      <div style={{ backgroundColor: 'white' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          ...
          <div style={{ padding: isMobile ? '0 12px 16px' : '0 32px 32px', marginTop: isMobile ? '-24px' : '-32px', display: 'flex', flexDirection: isMobile ? 'column' : 'row', alignItems: isMobile ? 'center' : 'flex-end', gap: '16px' }}>
            <div style={{ position: 'relative' }}>
              <img src={getFakeImageUrl(resultId, 'avatar')} style={{ width: isMobile ? '120px' : '168px', height: isMobile ? '120px' : '168px', borderRadius: '50%', border: '4px solid white', backgroundColor: 'white', filter: 'blur(30px) saturate(1.5)' }} alt="" />
            </div>
